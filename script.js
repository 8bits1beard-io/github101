 ...
 * Created: 2025-08-13
 * Description: Interactive functionality for GitHub tutorial for Windows Engineers
 */

// Tutorial state
let currentSection = 0;
const sections = ['intro', 'setup', 'basics', 'repositories', 'advanced', 'collaboration', 'best-practices', 'final-quiz'];
...
// Code examples for version demo
const codeVersions = {
    1: `# Initial PowerShell script
...
function showVersion(version) {
    ...
    const code = codeVersions[version];
    
    if (code && codeDisplay) {
        codeDisplay.innerHTML = `<pre><code class="language-powershell">${code}</code></pre>`;
...
From https://github.com/company/system-info-reporter
...
const quizQuestions = [
    ...
    {
        question: "After editing files locally, what's the first step to save your changes in Git?",
        options: [
            "git commit",
            "git push",
            "git save",
    ...
    {
        question: "Which command creates a new branch called 'feature-login'?",
        options: [
            "git branch feature-login",
            "git new feature-login",
            "git create-branch feature-login",
            "git make feature-login"
        ],
        correct: 0
    },
    {
        question: "How do you switch to an existing branch named 'development'?",
        options: [
            "git switch development",
            "git checkout development",
            "git change development",
    ...
    },
    {
        ...
        options: [
            ...
            "To specify which files Git should not track or commit",
    ...
    {
        question: "Which command creates a new tag for a release?",
        options: [
            "git release v1.0.0",
            "git tag v1.0.0",
            "git version v1.0.0",
...
function showQuizResults(correctAnswers, percentage, passed) {
    ...
    resultsContainer.innerHTML = `
        <div class="result-header">
            ...
            <p>You answered ${correctAnswers} out of ${quizQuestions.length} questions correctly.</p>
        </div>
            ...
            ${quizQuestions.map((q, index) => {
                ...
                return `
                    <div class="question-result ${isCorrect ? 'correct' : 'incorrect'}">
                        ...
                        <div class="user-answer">Your answer: ${q.options[userAnswer]}</div>
                        ${!isCorrect ? `<div class="correct-answer">Correct answer: ${q.options[q.correct]}</div>` : ''}
                    </div>
                `;
            }).join('')}
        </div>
...
function generateCertificate() {
    ...
    // Create HTML certificate display
    const certificateHTML = `
        <div class="certificate-display">
            ${isPerfectScore ? '<div class="perfect-score-badge">PERFECT SCORE</div>' : ''}
            ...
            <div class="certificate-details">
                ...
                <div class="certificate-signature">
                    ...
                    <div class="instructor-name">Joshua Walderbach</div>
                </div>
            </div>
        </div>
    `;
